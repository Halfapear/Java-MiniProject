...
import com.shapeville.task.sk1.angle.AngelRecognitionApp;
import com.shapeville.task.sk1.shape.ShapeRecognitionApp;
...
//            if (taskDef.getTaskId().equals(Constants.TASK_ID_SHAPE_ID_2D)) {
                // Task 1 – 2D Shape Identification
//                currentActiveTaskPanel = new ShapeRecognitionApp();
        
//            } else if (taskDef.getTaskId().equals(Constants.TASK_ID_ANGLE_TYPE)) {
                // Task 2 – Angle Type Identification
//                currentActiveTaskPanel = new AngelRecognitionApp();
...
//            } else 
            if (taskDef.getTaskId().equals(Constants.TASK_ID_AREA_CALC)) {
                ...
                // Bonus Task 1 – 3D Shape Identification
                currentActiveTaskPanel = new compound();
        
            } else if (taskDef.getTaskId().equals(Constants.TASK_ID_COMPOUND_AREA)) {
                // Bonus Task 2 – Compound Shape Area
